...
[`../logos-rln-membership-module`](../logos-rln-membership-module): fund via
...
liblogos_rln_membership_module/wallet-home/`), because the sandboxed QML
...
nix run 'path:.' -- --modules-dir <dir with installed modules> \
    --load liblogos_rln_membership_module
```
