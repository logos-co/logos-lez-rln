...
LogosScrollView {
    ...
    function doProvision() {
        busy = true
        M.call(bridge, M.MEMBERSHIP_MODULE, "provision_wallet_home",
    ...
    function fetchSuggestedAmount() {
        ...
        if (cfg === "")
            return
        M.call(bridge, M.RLN_MODULE, "get_registry_bounds", [cfg], function (r) {
    ...
    function deriveHolding(cfg, amount, tries) {
        ...
        M.call(bridge, M.WALLET_MODULE, "create_account_public", [], function (r) {
            ...
            M.call(bridge, M.RLN_MODULE, "get_token_balance", [acc], function (rb) {
    ...
    function submitClaim(cfg, acc, amount) {
        ...
        M.call(bridge, M.RLN_MODULE, "claim_tokens", [cfg, acc, amount], function (r) {
