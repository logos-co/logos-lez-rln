...
# 6. Delivery module C++ plugin (cmake with SDK pinned for invokeRemoteMethodAsync)
# 1468180b = SDK rev matching chat-module-master pin; provides truly-async
# invokeRemoteMethodAsync used by our std::promise/future trampoline.
log "Building delivery module plugin (cmake with SDK 1468180b)..."
SDK_PATH=$(nix build github:logos-co/logos-cpp-sdk/1468180b2567f4c59346bb94f74951e76341f5c5 --no-link --print-out-paths 2>/dev/null)
LIBLOGOS_PATH=$(nix build github:logos-co/logos-liblogos/7df6195 \
    --override-input logos-cpp-sdk github:logos-co/logos-cpp-sdk/1468180b2567f4c59346bb94f74951e76341f5c5 \
